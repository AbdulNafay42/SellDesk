      ...
      <main style={{
        ...
        <div style={{
          ...
          <div className="glass-card" style={{ padding: '22px' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', color: '#9CA3AF', marginBottom: '12px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '0.78rem', color: '#34D399', marginTop: '8px' }}>
          ...
          <div className="glass-card" style={{ padding: '22px' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', color: '#9CA3AF', marginBottom: '12px' }}>
              ...
              <div style={{ background: 'rgba(99, 102, 241, 0.15)', padding: '8px', borderRadius: '10px' }}>
                <ShoppingBag style={{ width: '18px', height: '18px', color: '#6366F1' }} />
              </div>
            </div>
            <div style={{ fontSize: '1.75rem', fontWeight: 800, color: '#FFF' }}>34 Orders</div>
            <div style={{ fontSize: '0.78rem', color: '#9CA3AF', marginTop: '8px' }}>
          ...
          <div className="glass-card" style={{ padding: '22px' }}>
            ...
            <div style={{ fontSize: '0.78rem', color: '#FBBF24', marginTop: '8px' }}>
          ...
          <div className="glass-card" style={{ padding: '22px' }}>
            ...
            <div style={{ fontSize: '0.78rem', color: '#FDA4AF', marginTop: '8px' }}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.04)', fontSize: '0.85rem' }}>
                    <td style={{ padding: '14px 8px', fontWeight: 700, color: '#34D399' }}>{row.id}</td>
                    <td style={{ padding: '14px 8px' }}>
                      <div style={{ fontWeight: 600, color: '#FFF' }}>{row.name}</div>
                      <div style={{ fontSize: '0.75rem', color: '#6B7280' }}>{row.phone}</div>
                    </td>
                    <td style={{ padding: '14px 8px', color: '#D1D5DB' }}>{row.item}</td>
                    <td style={{ padding: '14px 8px', fontWeight: 700, color: '#FFF' }}>{row.total}</td>
                    <td style={{ padding: '14px 8px' }}>
          ...
          <div className="glass-card" style={{ padding: '24px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              <div style={{ background: 'rgba(255, 255, 255, 0.03)', padding: '14px', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
                ...
                <div style={{ fontSize: '0.75rem', color: '#9CA3AF', marginTop: '8px', background: 'rgba(0,0,0,0.3)', padding: '6px', borderRadius: '6px' }}>
